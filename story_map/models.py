...
class Story(models.Model):
    ...
    attribution = models.CharField(blank=True, null=True, max_length=250)
    call_to_action = models.BooleanField(default=True)
    call_to_action_text = models.CharField(blank=True, null=True, max_length=250)
    language = models.CharField(default="en", max_length=2)
    map_background_color = models.CharField(default="#5f9468", max_length=15)
    map_subdomains = models.CharField(blank=True, null=True, max_length=25)
    map_type = models.CharField(blank=True, null=True, max_length=25)
    zoomify_path = models.CharField(blank=True, null=True, max_length=250)
    ...
    zoomify_attribution = models.CharField(blank=True, null=True, max_length=250)
...
class Slide(models.Model):
    story = models.ForeignKey(
        "Story", on_delete=models.CASCADE, related_name="has_slides"
    )
    ...
    media_caption = models.CharField(blank=True, null=True, max_length=250)
    media_credit = models.CharField(blank=True, null=True, max_length=250)
    media_url = models.URLField(blank=True, null=True, max_length=250)
    ...
    def location(self):
        if self.location_lat:
            item = {
                "iconSize": [self.location_icon_size_w, self.location_icon_size_l],
    ...
    @property
    def text(self):
        item = {"headline": self.text_headline, "text": self.text_text}
        return item
