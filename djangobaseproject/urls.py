...
router.register(
    r"ort-geojson", archiv_api_views.GeoJsonOrtViewSet, basename="ort-geojson"
)
router.register(
    r"fuzzy-ort-geojson",
    archiv_api_views.FuzzyGeoJsonOrtViewSet,
    basename="fuzzy-ort-geojson",
)
...
urlpatterns = [
    ...
    path(
        "openapi/",
        get_schema_view(
            title="MMP", description="Mapping Medieval Peoples", version="0.1.0"
        ),
        name="openapi-schema",
    ),
