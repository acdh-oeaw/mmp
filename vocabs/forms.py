...
class UploadFileForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.add_input(
            Submit("submit", "upload", css_id="uploadFile"),
        )
...
def custom_lang_errors(field_name):
    lang_errors = {
        "required": f"Language is required when {field_name.lower()} provided"
    }
        ...
        for form in self.forms:
            if form.cleaned_data:
                ...
                if name and not language:
                    raise forms.ValidationError("All names must have a lanaguge.")
                elif language and not name:
                    raise forms.ValidationError("All languages must have a name.")
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Fieldset(
                    "Add description", Formset("descriptions"), css_class="formset-div"
                ),
                Field(
                    "identifier",
                    placeholder="https://example.org/vocabulary-unique-title",
                ),
                Field("language"),
                Field("creator"),
                Field("contributor"),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Field("label_lang"),
                Fieldset(
                    "Add other labels or labels in other languages",
                    Formset("labels"),
                    css_class="formset-div",
                ),
                Field("scheme"),
                ...
                Field("legacy_id"),
                Fieldset(
                    "Add documentary note", Formset("notes"), css_class="formset-div"
                ),
                Fieldset(
                    "Add source information",
                    Formset("sources"),
...
class SkosConceptForm(forms.ModelForm):
    broader_concept = TreeNodeChoiceField(
        ...
        widget=autocomplete.ModelSelect2(
            url="vocabs-ac:skosconcept-autocomplete", forward=["scheme"]
        ),
    ...
    collection = forms.ModelMultipleChoiceField(
        ...
        widget=autocomplete.ModelSelect2Multiple(
            url="vocabs-ac:skoscollection-autocomplete", forward=["scheme"]
        ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            Div(
                ...
                Fieldset(
                    "Add other labels", Formset("labels"), css_class="formset-div"
                ),
                Field("scheme"),
                # Field('top_concept'),
                Field("collection"),
