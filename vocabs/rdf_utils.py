        ...
        if obj.scheme:
            ...
            if obj.scheme.title:
                g.add(
                    (
                        main_concept_scheme,
                        DC.title,
                        Literal(obj.scheme.title, lang=obj.scheme.title_lang),
                    )
                )
                g.add(
                    (
                ...
                for title in obj.scheme.has_titles.all():
                    g.add(
                        (
                            main_concept_scheme,
                            DC.title,
                            Literal(title.name, lang=title.language),
                        )
                    )
                ...
                for desc in obj.scheme.has_descriptions.all():
                    g.add(
                        (
                            main_concept_scheme,
                            DC.description,
                            Literal(desc.name, lang=desc.language),
                        )
                    )
            ...
            g.add(
                (
                    main_concept_scheme,
                    DCT.created,
                    Literal(obj.scheme.date_created, datatype=XSD.dateTime),
                )
            )
            g.add(
                (
                    main_concept_scheme,
                    DCT.modified,
                    Literal(obj.scheme.date_modified, datatype=XSD.dateTime),
                )
            )
                        ...
                        if y.legacy_id:
                            ...
                            g.add(
                                (
                                    ...
                                    SKOS.member,
                                    URIRef(
                                        main_concept_scheme + "#concept" + str(y.id)
                                    ),
                                )
                            )
        # Concept properties
                ...
                if x.legacy_id:
                    ...
                    g.add(
                        (
                            concept,
                            SKOS.narrower,
                            URIRef(main_concept_scheme + "#concept" + str(x.id)),
                        )
                    )
