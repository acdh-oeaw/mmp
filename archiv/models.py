...
class Text(models.Model):
    ...
    def not_before_normalized(self):
        if self.start_date and not self.not_before:
            not_before = self.start_date
            return f'notBefore="{not_before}"'
        elif self.start_date and self.not_before:
            not_before = self.not_before
            return f'notBefore="{not_before}"'
        elif not self.start_date and self.not_before:
            not_before = self.not_before
            return f'notBefore="{not_before}"'
        elif not self.start_date and not self.not_before:
            not_before = str(2020)
            return f'notBefore="{not_before}"'

    def not_after_normalized(self):
        if self.end_date and not self.not_after:
            not_after = self.end_date
            return f'notAfter="{not_after}"'
        elif self.end_date and self.not_after:
            not_after = self.not_after
            return f'notAfter="{not_after}"'
        elif not self.end_date and self.not_after:
            not_after = self.not_after
            return f'notAfter="{not_after}"'
        elif not self.end_date and not self.not_after:
            not_after = str(-100)
            return f'notAfter="{not_after}"'
