...
class SpatialCoverageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "key_word": autocomplete.ModelSelect2(url="archiv-ac:keyword-autocomplete"),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.layout = Layout(
            Fieldset(
                ...
                "stelle__end_date",
                "stelle__key_word",
                "stelle__key_word_and",
                "stelle__key_word__art",
                "stelle__text__autor",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.layout = Layout(
            ...
            Accordion(
                ...
                AccordionGroup("admin", css_id="admin_search"),
            ),
        )
...
class AutorForm(forms.ModelForm):
    class Meta:
        model = Autor
        fields = "__all__"
        widgets = {"ort": autocomplete.ModelSelect2(url="archiv-ac:ort-autocomplete")}
...
class StelleForm(forms.ModelForm):
    class Meta:
        ...
        fields = "__all__"
        widgets = {
            "text": autocomplete.ModelSelect2(url="archiv-ac:text-autocomplete"),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.layout = Layout(
            ...
            Accordion(
                ...
                AccordionGroup("admin", "id", "kommentar", css_id="admin_search"),
            ),
        )
...
class EventFilterFormHelper(FormHelper):
    def __init__(self, *args, **kwargs):
        ...
        self.layout = Layout(
            ...
            Accordion(
                AccordionGroup(
                    "Advanced search", "start_date", "end_date", css_id="more"
                ),
            ),
        )
